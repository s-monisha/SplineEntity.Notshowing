...
private:
    dxfRW &dxfW;
    vector<DRW_Entity*> container;
public:
    void getElement(DRW_Entity *element){
    ...
    void Spline(double ex, double ey, double ez, double tgez, double tgsz, double tgsx, double tgsy, double tgex, double tgey, int flags, int degree, string layer);
